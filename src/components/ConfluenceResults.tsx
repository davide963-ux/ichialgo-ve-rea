...
export function ConfluenceResults({ result, startingBalance, riskPct }: Props) {
  ...
  if (result.trades.length === 0) {
    return (
      <div className="empty">
        ...
        <p>
          It checked {result.barsAnalysed.toLocaleString()} candles and found nothing that met all six conditions at
          once. Try a longer date range, a different pair, or the 4H timeframe.
        </p>
      </div>
    );
  }
